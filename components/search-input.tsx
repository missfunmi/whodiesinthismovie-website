 ...
 * Shows a spinning loader when isLoading is true.
 */
export default function SearchInput({
  ...
  return (
    <div className="relative">
      {isLoading ? (
        <Loader2 className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none animate-spin" />
      ) : (
