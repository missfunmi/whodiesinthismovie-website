...
- Core website:
	...
	- LLM: Google Gemini 3.0 Flash (primary, via @google/genai SDK) with Ollama + Mistral 7B fallback (for query validation and death data extraction)
